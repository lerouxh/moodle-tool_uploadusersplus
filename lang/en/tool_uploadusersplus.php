...
$string['setting_hideoptionroleenrolments'] = 'Hide option for Role enrolments';
$string['setting_hideoptionroleenrolments_desc'] = 'Hide the Include role fields option from the Create an upload template section.';
$string['setting_hideoptionenroltimestart'] = 'Hide option for enrolment start dates';
$string['setting_hideoptionenroltimestart_desc'] = 'Hide the Include enrolment start dates option from the Create an upload template section.';
$string['setting_hideoptionenrolperiod'] = 'Hide option for enrolment periods';
$string['setting_hideoptionenrolperiod_desc'] = 'Hide the Include enrolment periods option from the Create an upload template section.';
$string['setting_hideoptionenrolstatus'] = 'Hide option for enrolment statuses';
$string['setting_hideoptionenrolstatus_desc'] = 'Hide the Include enrolment statuses option from the Create an upload template section.';
...
$string['settingsdeletesuspend'] = 'Delete/Suspend';
$string['setting_hideoptiondeletedfield'] = 'Hide option for deleted field';
$string['setting_hideoptiondeletedfield_desc'] = 'Hide the Include deleted field option from the Create an upload template section.';
$string['setting_hideoptionsuspendedfield'] = 'Hide option for suspended field';
$string['setting_hideoptionsuspendedfield_desc'] = 'Hide the Include suspended field option from the Create an upload template section.';
...
$string['courseenrolments_help'] = 'Include repeated course columns in the generated template, with optional role, enrolment date, enrolment status, and group columns.';
$string['numberofcourses'] = 'Number of courses';
$string['numberofcourses_help'] = 'Enter a whole number from 1 to 99. The generated template will include course1 through courseN and any selected matching enrolment fields.';
$string['includerolefields'] = 'Include role fields';
$string['includerolefields_help'] = 'Use the role shortname as defined in Site administration > Users > Permissions > Define roles, for example student or editingteacher. If no role is specified, users are enrolled using the course default enrolment role, normally student.';
$string['includeenroltimestart'] = 'Include enrolment start dates';
$string['includeenroltimestart_help'] = 'Add enroltimestart fields for each selected course. Use a date such as 2021-02-15 or a date and time such as 2021-02-15 15:30. If omitted, Moodle normally uses today as the enrolment start date.';
$string['includeenrolperiod'] = 'Include enrolment periods';
$string['includeenrolperiod_help'] = 'Add enrolperiod fields for each selected course. Enter the enrolment duration in days. If omitted, Moodle uses the duration configured in the course manual enrolment method; 0 normally means unlimited.';
$string['includeenrolstatus'] = 'Include enrolment statuses';
$string['includeenrolstatus_help'] = 'Add enrolstatus fields for each selected course. Use 1 to suspend the course enrolment and 0 to unsuspend or reactivate it. If omitted, new enrolments are normally active.';
$string['cohortenrolments'] = 'Cohort enrolments';
$string['cohortenrolments_help'] = 'Include repeated cohort columns in the generated template for adding users to existing cohorts.';
...
$string['deletesuspendheading'] = 'Delete / Suspend accounts';
$string['includedeletedfield'] = 'Include deleted field';
$string['includedeletedfield_help'] = 'Add the Moodle deleted field. Enter 1 in a row to delete an existing user account. Use this carefully; deleting a user prevents that user from logging in.';
$string['includesuspendedfield'] = 'Include suspended field';
$string['includesuspendedfield_help'] = 'Add the Moodle suspended field. Enter 1 to suspend an existing user account. Enter 0 to unsuspend or reactivate the account.';
...
$string['error_invalidrole'] = 'Invalid role value.';
$string['error_invalidenroltimestart'] = 'Invalid enrolment start date.';
$string['error_invalidenrolperiod'] = 'Invalid enrolment period. Enter a whole number of days.';
$string['error_invalidenrolstatus'] = 'Invalid enrolment status. Use 0 or 1.';
$string['error_invaliddeleted'] = 'Invalid deleted value. Use 0 or 1.';
$string['error_invalidsuspended'] = 'Invalid suspended value. Use 0 or 1.';
...
$string['error_coursefieldwithoutcourse'] = 'A course enrolment field was provided without a matching course value.';
...
$string['rowvalidationissueprofilefieldfree'] = 'Line {$a->line}: {$a->message}';
...
$string['invalidprofilefieldfree'] = 'Invalid profile field value - details available in {$a}';
